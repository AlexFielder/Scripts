...
$VaultName = "WACvault1" #fetch automatically
$Subscription = "Pay-As-You-Go" #fetch automatically
$ResourceGroup = "WACResourceGroup" #fetch automatically
$SubscriptionId = "b2ae8e9b-168e-4392-b5b9-656f0093171a" #fetch automatically
